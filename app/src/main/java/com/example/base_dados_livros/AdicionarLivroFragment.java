...
public class AdicionarLivroFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        s = (Spinner) view.findViewById(R.id.spinnerCategoria);

        LoaderManager.getInstance(this).initLoader(ID_CURSOR_LOADER_CATEGORAS, null, this);
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        return new CursorLoader(getContext(), LivrosContentProvider.ENDERECO_CATEGORIAS, BdTableLivros.TODOS_CAMPOS, null, null, BdTableCategorias.CAMPO_DESCRICAO);
    }
    ...
    public void onLoadFinished(@NonNull Loader<Cursor> loader, Cursor data) {
        mostrarDadosSpinnerCategorias(data);
    }

    private void mostrarDadosSpinnerCategorias(Cursor data) {
    ...
    public void onLoaderReset(@NonNull Loader<Cursor> loader) {
        mostrarDadosSpinnerCategorias(null);
    }
}
